...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Base trail color //yellow
    //const vec4 TRAIL_COLOR = vec4(1.0, 1.0, 0.0, 1.0);
    // Base trail color //orange
    //const vec4 TRAIL_COLOR = vec4(1.0, 0.55, 0.0, 1.0);
    // Base trail color //terminal orange
    const vec4 TRAIL_COLOR = vec4(1.0, 0.45, 0.0, 1.0);
    // Base trail color //catpuccin mocha peach
    //const vec4 TRAIL_COLOR = vec4(0.98, 0.70, 0.53, 1.0);
